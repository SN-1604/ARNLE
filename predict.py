...
with tf.Session() as sess:
    ...
    with tqdm(total=args.data.shape[0] // args.batchsize) as pbar:
        label_one_test = [args.num_class] * args.data.shape[0]
        for batch in get_batch(args.data, label, args.batchsize, args.sequence_length, False):
